package com.flocier.trigger.http.admin;

import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.flocier.api.IAiAgentDrawAdminService;
...
import com.flocier.infrastructure.dao.IAiAgentDao;
import com.flocier.infrastructure.dao.IAiAgentDrawConfigDao;
import com.flocier.infrastructure.dao.IAiAgentFlowConfigDao;
import com.flocier.infrastructure.dao.IAiClientConfigDao;
import com.flocier.infrastructure.dao.po.AiAgent;
import com.flocier.infrastructure.dao.po.AiAgentDrawConfig;
import com.flocier.infrastructure.dao.po.AiAgentFlowConfig;
import com.flocier.infrastructure.dao.po.AiClientConfig;
import com.flocier.trigger.http.admin.util.DrawConfigParser;
            ...
            if (result > 0) {
                ...
                try {
                    ...
                    if (!configRelations.isEmpty()) {
                        ...
                        //TODO 可能有bug，deleteBySourceId应该用clientId和modelId来删除
                        if (existingConfig != null) {
